...
set my_verilog_files [list datapath.v fsm_controller.v top.v]

#/* Top-level Module Name update                            */
set my_toplevel soccer_stars_top
...
# Force Synthesis to keep these ports and their related logic
set_dont_touch [get_ports state_out]
set_dont_touch [get_ports add_x_y]
set_dont_touch [get_ports add_x_acc]
set_dont_touch [get_ports x_reg_data]
set_dont_touch [get_ports y_reg_data]
